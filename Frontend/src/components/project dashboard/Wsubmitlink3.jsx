  ...
  useEffect(() => {
    const fetchSubmissionData = async () => {
      ...
      try {
        ...
        const week1Data = response.data.find(item => item.week_name === 'Week 3');
      ...
      <Grid container justifyContent="center" style={{ marginTop: "13%" }}>
        <Grid item xs={12} md={10} lg={8}>
          <TableContainer component={Paper} style={{ marginBottom: "20px" }}>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="submission 3 table">
              <TableBody>
                <TableRow>
                ...
                <TableRow>
                  <TableCell component="th" scope="row">
                    <Link to={'/wsubmitform3'} style={{ textDecoration: 'none' }}>
                      <Button 
                        variant="contained" 
                        color="primary" 
